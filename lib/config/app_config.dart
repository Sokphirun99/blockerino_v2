...
class AppConfig {
  ...
  /// Using ScreenUtil for responsive sizing - these are in logical pixels
  /// that will scale correctly across all screen sizes and aspect ratios
  static const double boardContainerPadding = 4.0;
  static const double boardBorderWidth = 2.0;

  /// Board size in pixels (scaled using ScreenUtil)
  /// This is the main board size that scales perfectly across all devices
  /// Uses 320 logical pixels (85% of design width 375) which ensures
  /// the board fits properly on phones, tablets, and foldables
  static double get boardSize => 320.w;
  ...
  static const EdgeInsets paddingHorizontal20Vertical10 =
      EdgeInsets.symmetric(horizontal: 20.0, vertical: 10.0);
  static const EdgeInsets paddingHorizontal20Vertical12 =
      EdgeInsets.symmetric(horizontal: 20.0, vertical: 12.0);
  static const EdgeInsets paddingHorizontal32Vertical12 =
  ...
  static Color gameBackgroundMiddle =
  ...
  static Color backgroundOverlay2 =
  ...
  static const String eventStorePurchase =
      'store_purchase'; // Changed from in_app_purchase
  ...
  /// Get the board size (backward compatibility method)
  /// Now uses the static boardSize getter for consistent scaling
  ///
  /// Note: The context parameter is kept for backward compatibility
  /// but is no longer needed since ScreenUtil works globally
  ...
  static double getEffectiveBoardSize(BuildContext context) =>
      getEffectiveSize(context);
