...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    'zh': {
      ...
      'daily_subtitle': '今日挑战',
      'daily_missions': '每日任务',
      'daily_missions_subtitle': '完成任务获得奖励',
      'store': '商店',
      ...
      // Tutorial
      'skip_tutorial': '跳过教程',
      'tutorial_welcome_title': '欢迎来到 Blockerino！',
      'tutorial_welcome_desc': '匹配并消除线条来获得分数。让我们学习如何玩！',
      'tutorial_lets_go': '开始吧！',
      'tutorial_drag_title': '拖动方块',
      'tutorial_drag_desc': '从托盘中拖动方块到棋盘上。战略性地放置它们！',
      'tutorial_drag_hint': '现在试着拖动一个方块！',
      'tutorial_clear_title': '消除线条',
      'tutorial_clear_desc': '完成整行或整列来消除它们并获得分数。',
      'tutorial_clear_hint': '填满一整行或一整列！',
      'tutorial_combo_title': '连击系统',
      'tutorial_combo_desc': '连续消除多条线获得连击奖励！连击越多 = 分数越高！',
      'tutorial_got_it': '知道了！',
      'tutorial_gameover_title': '游戏结束',
      'tutorial_gameover_desc': '当没有方块能放到棋盘上时游戏结束。提前规划！',
      'tutorial_start_playing': '开始游戏！',
    },
    ...
    'km': {
      ...
      'daily_missions': 'បេសកកម្មប្រចាំថ្ងៃ',
      'daily_missions_subtitle': 'បំពេញការងារដើម្បីទទួលរង្វាន់',
      'store': 'ហាង',
      ...
      // Tutorial
      'skip_tutorial': 'រំលងការណែនាំ',
      'tutorial_welcome_title': 'សូមស្វាគមន៍មកកាន់ Blockerino!',
      'tutorial_welcome_desc': 'ផ្គូផ្គង និងលុបបន្ទាត់ដើម្បីទទួលពិន្ទុ។ តោះរៀនវិធីលេង!',
      'tutorial_lets_go': 'តោះចាប់ផ្តើម!',
      'tutorial_drag_title': 'អូសដុំ',
      'tutorial_drag_desc': 'អូសដុំពីថាសទៅក្តារ។ ដាក់វាដោយយុទ្ធសាស្ត្រ!',
      'tutorial_drag_hint': 'សាកល្បងអូសដុំឥឡូវនេះ!',
      'tutorial_clear_title': 'លុបបន្ទាត់',
      'tutorial_clear_desc': 'បំពេញជួរដេក ឬជួរឈរពេញលេញដើម្បីលុបពួកវា និងទទួលពិន្ទុ។',
      'tutorial_clear_hint': 'បំពេញជួរដេក ឬជួរឈរពេញលេញ!',
      'tutorial_combo_title': 'ប្រព័ន្ធការបន្ត',
      'tutorial_combo_desc': 'លុបបន្ទាត់ច្រើនជាប់គ្នាដើម្បីទទួលពិន្ទុប៉ោណាស់! ការបន្តកាន់តែច្រើន = ពិន្ទុកាន់តែច្រើន!',
      'tutorial_got_it': 'យល់ហើយ!',
      'tutorial_gameover_title': 'ចប់ហ្គេម',
      'tutorial_gameover_desc': 'ហ្គេមបញ្ចប់នៅពេលគ្មានដុំណាអាចដាក់នៅលើក្តារបាន។ រៀបចំផែនការមុន!',
      'tutorial_start_playing': 'ចាប់ផ្តើមលេង!',
    },
  };
